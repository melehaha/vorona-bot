...
async def why_honest(message: Message):
    await message.answer(
        ...
        "3. Если не найду вам авто - верну депозит.\n"
...
async def how_it_works(message: Message):
    steps = (
        ...
        "Но если честно, читать это довольно скучно, поэтому переходите ко мне в Instagram: https://instagram.com/vorona.car Там я рассказываю это веселее"
    )
